...
The picture shows the result of playing the chaos game on a penthagon, with an additional rule: we cannot choose the same vertex two times in a row. This produces this mesmerizing (pehthagonal) snowflake shape, which seems adequate for these freezing winter days. If you look closely, you can see that the fractal is filled with some terrifying faces that remind me of the ancient sculptures of the Inca god Viracocha. \\
...
\artpage[../Output/LowQuality/MIB0058_DoubleTwistColumn.png]{Double Twist Column}{%
Antoni Gaudí (1852 - 1926) was a Catalan architect who had a great importance in the Catalan art nouveau, also known as Modernisme. Some of his most famous works, Casa Milà (La Pedrera), Casa Batlló, and Parc Güell are among the main tourist attractions in Barcelona. However, the most important work is the still unfinshed temple of La Sagrada Família. Inside of that church, Gaudí introduced the so-called double twist columns, which I try to explain in this post.\\

The shape of this columns is created with two star-shaped bases that start at the lower end and rotate in opposite directions as they rise towards the ceiling. The section of the column is taken as the intersection of these two shapes at each level. This gradually creates a new set of nerves along the column. Once the section becomes a regular star again, we take this shape as a new base, and keep rotating at the same rate.\\

This very visual method allowed Gaudí to design beams and columns that look very organic, resembling trees and branches, without the use of any modern design software. This column becomes perfectly circular at a finite height, which is twice the height of the first segment. You can check this by the sum of the geometric series, as each segment has half the length of the previous ones.\\

Do it yourself! Source code: \url{https://github.com/raimonluna/MathIsBeautiful/blob/main/MIB_2026/MIB_2026_03/MIB0058_DoubleTwistColumn.py}
}

\artpage[../Output/LowQuality/MIB0059_GoldenRatio.png]{Golden Ratio}{%
The Fibonacci sequence is probably the most famous sequence in history. Each term of the sequence is obtained as the sum of the two previous ones: 1, 1, 2, 3, 5, 8, 13, 21... The sequence is so famous that you can actually see a few of its numbers a street art monument in Barcelona created in 1992 by Mario Merz, in the district of Barceloneta. \\

A remarkable property of this sequence is that the ratio between consecutive Fibonacci numbers approaches a very particular number: the golden ratio. This number, $\phi$ = 1.61803..., has many interesting properties and has often been called the divine proportion. Both the Fibonacci numbers and the golden ratio appear very frequently in architecture, design and in nature itself. \\

The video shows a representation of the golden spiral, obtained by stacking squares whose sides follow the fibonacci numbers. You can check that each size is the sum of the two previous ones. The proportion of the whole construction approaches a golden rectangle, enclosing a logarithmic spiral with base $\phi$.\\

Do it yourself! Source code: \url{https://github.com/raimonluna/MathIsBeautiful/blob/main/MIB_2026/MIB_2026_03/MIB0059_GoldenRatio.py}
}

\artpage[../Output/LowQuality/MIB0060_BarnsleyZoom.png]{Barnsley Zoom}{%

This is an attempt to generate a infinite zoom into the Barnsley fern, which was already featured in the second publication of this channel. This continuous rescaling of the fern highlights its self-similarity, using the same linear transformations that generate it in the first place. \\

I wrote a first version this animation code for a nice article on the renormalization group flow written by @tbertolez. I publish here a more trippy version of the animation with his permission. \\

Do it yourself! Source code: \url{https://github.com/raimonluna/MathIsBeautiful/blob/main/MIB_2026/MIB_2026_03/MIB0060_BarnsleyZoom.py}
}

\artpage[../Output/LowQuality/MIB0061_OneRing.png]{The One Ring of Power}{%

My precioussss... Believe it or not, this picture of the One Ring of Power is created by very simple mathematical equations. These particular systems are known as Peter de Jong Attractors, and were first published in the Computer Recreations section of Scientific American, in July 1987, in an article by Alexander Keewatin Dewdney. The picture is created as the orbit of points under some particular trigonometric mapping.\\

There is a very large variety of attractors such as the ones by Peter de Jong. They usually contain several free numerical parameters that can be adjusted to produce all kinds of shapes. People have been exploring huge amounts of these shapes and naming them according to their imagination. I could probably fill a whole new channel just with this amazing jungle of mathematical beasts. The parameters that create the One Ring are a contribution by Johnny Svensson in Paul Bourke's incredible website. Make sure to check it out!\\

Do it yourself! Source code: \url{https://github.com/raimonluna/MathIsBeautiful/blob/main/MIB_2026/MIB_2026_04/MIB0061_OneRing.py}
}
